...
public class Common {
	...
	public static By screeningQuesdropDwn = By.xpath(
			"//div[contains(@class,'ant-col ant-col-md-24 ant-col-lg-16')]//div[contains(@class,'ant-select-selection__rendered')]");
	...
	public static By screeningChartdropDwn = By.xpath(
			"//div[contains(@class,'ant-col ant-col-md-12 ant-col-lg-8')]//div[contains(@class,'ant-select-selection__rendered')]");
